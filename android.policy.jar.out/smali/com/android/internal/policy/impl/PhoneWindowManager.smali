...
.field public static final KEYGUARD_UPDATE_SECURE:Ljava/lang/String; = "lenovo.intent.action.KEYGUARD_UPDATE_SECURE"
...
.field private mHomeDoubleTap:Z
...
.field mKeyguardUpdateSecureReceiver:Landroid/content/BroadcastReceiver;
...
.field private mLastHomeDownTime:J
...
.field private final mLaunchHomeRunnable:Ljava/lang/Runnable;

.field private mLeVoiceEnabled:Z

.field private mLeVoiceHandled:Z

.field mLenovoHeadsetManager:Lcom/android/internal/policy/impl/LenovoHeadsetManager;

.field mLidControlsSleep:Z

.field mLeVoicePowerEnabled:Z
...
.field private final mPowerLongPressForLeVoice:Ljava/lang/Runnable;
...
.field mSmartRollFloatWindowService:Lcom/lenovo/SmartRoll/SmartRollFloatWindowService;
...
.method public constructor <init>()V
    ...
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceHandled:Z

    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoicePowerEnabled:Z

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastHomeDownTime:J

    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeDoubleTap:Z
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSmartRollFloatWindowService:Lcom/lenovo/SmartRoll/SmartRollFloatWindowService;

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mWideTouchService:Lcom/lenovo/widetouch/WideTouchService;

    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIsSideKeyBacklight:Z
    ...
    iput v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenOffReason:I
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLaunchHomeRunnable:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/internal/policy/impl/PhoneWindowManager$3;

    invoke-direct {v0, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$3;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V

    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerLongPressForLeVoice:Ljava/lang/Runnable;
    ...
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mfindingTopFullscreenOpaque:Z
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardUpdateSecureReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$200(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
    ...
    .prologue
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->startLeVoice()V
...
.method private interceptPowerKeyDownForLeVoice()V
    .locals 4

    .prologue
    const-string v0, "WindowManager"

    const-string v1, "*****interceptPowerKeyDownForLeVoice"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerLongPressForLeVoice:Ljava/lang/Runnable;
...
.method private interceptPowerKeyUpForLeVoice()V
    .locals 3
    ...
    const-string v2, "*****interceptPowerKeyUpForLeVoice  mLeVoiceHandled:"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceHandled:Z
    ...
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceHandled:Z

    if-nez v0, :cond_0

    const-string v0, "WindowManager"

    const-string v1, "*****remove longPressForLeVoice!"
    ...
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceHandled:Z
...
.method public finishPostLayoutPolicyLw()I
    ...
    invoke-virtual {v8}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->isSecure()Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    invoke-direct {v5, p0, v10}, Lcom/android/internal/policy/impl/PhoneWindowManager$PolicyHandler;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Lcom/android/internal/policy/impl/PhoneWindowManager$1;)V
    ...
    invoke-direct {v5, p0, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager$SettingsObserver;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/Handler;)V
    ...
    invoke-direct {v5, v8, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyDispatchReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string v5, "android.intent.action.stk.USER_ACTIVITY.enable"

    invoke-virtual {v4, v5}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mStkUserActivityEnReceiver:Landroid/content/BroadcastReceiver;
    ...
    .local v3, keyguardFilter:Landroid/content/IntentFilter;
    const-string v5, "lenovo.intent.action.KEYGUARD_UPDATE_SECURE"

    invoke-virtual {v3, v5}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardUpdateSecureReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v5, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getLongIntArray(Landroid/content/res/Resources;I)[J
    ...
    new-instance v5, Lcom/android/internal/policy/impl/LenovoHeadsetManager;

    invoke-direct {v5, p1}, Lcom/android/internal/policy/impl/LenovoHeadsetManager;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLenovoHeadsetManager:Lcom/android/internal/policy/impl/LenovoHeadsetManager;
    ...
    :goto_1
    const-string v5, "persist.applaunchtime.enable"
    ...
    :goto_2
    iput-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAppLaunchTimeEnabled:Z
    ...
    const-string v8, "levoice_enable"
    ...
    :goto_3
    iput-boolean v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceEnabled:Z
    ...
    .end local v3           #keyguardFilter:Landroid/content/IntentFilter;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    iget-boolean v13, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomePressed:Z

    .local v13, bHomeDown:Z
    const/4 v3, 0x0
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeDoubleTap:Z

    if-nez v3, :cond_7

    const-string v3, "WindowManager"

    const-string v5, "post home task"
    ...
    iget-object v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLaunchHomeRunnable:Ljava/lang/Runnable;
    ...
    const-string v6, " last down time: "
    ...
    iget-wide v6, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastHomeDownTime:J
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceEnabled:Z

    if-eqz v3, :cond_12

    move-object/from16 v0, p0

    iget-wide v5, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastHomeDownTime:J
    ...
    const-string v5, "double tap :remove launching home"
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeDoubleTap:Z

    const-string v3, "WindowManager"

    const-string v5, "double tap :start levoice..."
    ...
    iput-wide v0, v2, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastHomeDownTime:J
    ...
    .local v35, sosService:Landroid/content/Intent;
    const-string v3, "com.lenovo.sos.start"

    move-object/from16 v0, v35

    invoke-virtual {v0, v3}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string v3, "com.lenovo.sos"

    const-string v5, "com.lenovo.sos.SosService"
    ...
    .end local v35           #sosService:Landroid/content/Intent;
    :cond_20
    move-object/from16 v0, p0
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iget-boolean v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoicePowerEnabled:Z

    if-eqz v12, :cond_20

    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyDownForLeVoice()V
    ...
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyUpForLeVoice()V
    ...
    .end local v11           #telephonyService:Lcom/android/internal/telephony/ITelephony;
    :sswitch_6
    iget-object v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLenovoHeadsetManager:Lcom/android/internal/policy/impl/LenovoHeadsetManager;

    move-object/from16 v0, p1

    invoke-virtual {v12, v0}, Lcom/android/internal/policy/impl/LenovoHeadsetManager;->interceptHeadsetKeyBeforeQueueing(Landroid/view/KeyEvent;)Z
...
.method public isLeVoiceEnabled()Z
    .locals 3
    ...
    const-string v2, "levoice_enable"
    ...
    :cond_0
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceEnabled:Z

    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceEnabled:Z
...
.method public keyguardDone(Z)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->keyguardDone(ZZ)V
...
.method public onWallpaperCompleted()V
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->onWallpaperStateChanged(Z)V
...
.method public updateSettings()V
    ...
    const-string v9, "levoice_enable"
    ...
    :goto_0
    iput-boolean v9, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLeVoiceEnabled:Z
