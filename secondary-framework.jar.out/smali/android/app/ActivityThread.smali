...
# static fields
.field public static final ACTIVITY_THREAD_ORIENTATION_STATE:Ljava/lang/String; = "android.intent.action.ACTIVITY_THREAD_ORIENTATION_STATE"
...
.field public static final ORIENTATION_STATE_DATA:Ljava/lang/String; = "orientation_state_data"
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 4157
    invoke-virtual {p0, p1, v2}, Landroid/app/ActivityThread;->freeAllCachesIfNeeded(Landroid/content/res/Configuration;I)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    .line 2934
    .local v7, record:Landroid/app/ActivityThread$ActivityClientRecord;
    invoke-virtual {p0}, Landroid/app/ActivityThread;->getSystemContext()Landroid/app/ContextImpl;
    ...
    const-string v10, "android.intent.action.ACTIVITY_THREAD_ORIENTATION_STATE"

    invoke-direct {v4, v10}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 2936
    .local v4, intent:Landroid/content/Intent;
    const-string v10, "orientation_state_data"

    iget-object v11, v7, Landroid/app/ActivityThread$ActivityClientRecord;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget v11, v11, Landroid/content/pm/ActivityInfo;->screenOrientation:I

    invoke-virtual {v4, v10, v11}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 2937
    invoke-virtual {v1, v4}, Landroid/app/ContextImpl;->sendBroadcast(Landroid/content/Intent;)V

    .line 2938
    const-string v10, "ActivityThread"

    const-string v11, "jiajh handleResumeActivity,PWM_ORIENTATION_STATE = 1"
    ...
    :cond_0
    :goto_2
    iget-object v10, v6, Landroid/app/ActivityThread$ActivityClientRecord;->window:Landroid/view/Window;
    ...
    iput v10, v5, Landroid/view/WindowManager$LayoutParams;->type:I
    ...
    .line 2977
    invoke-interface {v9, v2, v5}, Landroid/view/ViewManager;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v11, v6, Landroid/app/ActivityThread$ActivityClientRecord;->newConfig:Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v10}, Landroid/app/ActivityThread;->freeTextLayoutCachesIfNeeded(I)V
    ...
    invoke-interface {v9, v2, v5}, Landroid/view/ViewManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-boolean v10, v6, Landroid/app/ActivityThread$ActivityClientRecord;->onlyLocalRequest:Z
    ...
    iput-boolean v10, v6, Landroid/app/ActivityThread$ActivityClientRecord;->hideForNow:Z
