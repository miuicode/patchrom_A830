...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 390
    new-instance v65, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct/range {v65 .. v65}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V
    ...
    .line 1093
    .local v53, tempcolor:Landroid/content/res/ColorStateList;
    if-eqz v53, :cond_a
    ...
    invoke-virtual/range {v65 .. v66}, Landroid/content/res/Resources;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual/range {v65 .. v66}, Landroid/content/res/Resources;->getColor(I)I
    ...
    .end local v53           #tempcolor:Landroid/content/res/ColorStateList;
    ...
    .line 1101
    .restart local v53       #tempcolor:Landroid/content/res/ColorStateList;
    :cond_2a
    const v65, 0x1060071
...
.method private invertTextColor(I)Landroid/content/res/ColorStateList;
    ...
    .sparse-switch
        ...
        0x1060010 -> :sswitch_3
        0x1060011 -> :sswitch_6
        0x106006e -> :sswitch_12
        0x106006f -> :sswitch_13
        0x1060071 -> :sswitch_c
        0x1060072 -> :sswitch_f
        0x1060073 -> :sswitch_7
        0x1060074 -> :sswitch_14
        0x1060075 -> :sswitch_16
        0x1060078 -> :sswitch_d
        0x1060079 -> :sswitch_10
        0x106007a -> :sswitch_15
        0x106007b -> :sswitch_17
        0x106007e -> :sswitch_e
        0x106007f -> :sswitch_11
    .end sparse-switch
.end method
...
.method private paste(II)V
    ...
    .line 8405
    .local v4, method:Landroid/text/method/TransformationMethod;
    if-eqz v4, :cond_1

    instance-of v8, v4, Landroid/text/method/PasswordTransformationMethod;
    ...
    invoke-virtual {v8, v9}, Landroid/content/ClipData$Item;->coerceToStyledText(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    .line 8421
    invoke-virtual {p0, p1, p2, v7}, Landroid/widget/TextView;->prepareSpacesAroundPaste(IILjava/lang/CharSequence;)J
    ...
    invoke-static {v8, p2}, Landroid/text/Selection;->setSelection(Landroid/text/Spannable;I)V
    ...
    invoke-interface {v8, p1, p2, v7}, Landroid/text/Editable;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;
    ...
    invoke-interface {v8, v9, v7}, Landroid/text/Editable;->insert(ILjava/lang/CharSequence;)Landroid/text/Editable;
...
.method private setTypefaceFromAttrs(Ljava/lang/String;II)V
    ...
    invoke-virtual {v1}, Landroid/content/Context;->isIgnoreBoldFont()Z
...
.method canPaste()Z
    ...
    .line 8321
    .local v0, isPasswrodInSettings:Z
    if-eqz v1, :cond_0
...
.method getTransformedText(II)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 8162
    iget-object v1, p0, Landroid/widget/TextView;->mTransformed:Ljava/lang/CharSequence;
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2, v3}, Landroid/content/Context;->setIgnoreBoldFont(Z)V
    ...
    .line 1219
    .restart local v0       #strCountry:Ljava/lang/String;
    .restart local v1       #strLocal:Ljava/lang/String;
    :cond_2
    invoke-virtual {p0}, Landroid/widget/TextView;->getContext()Landroid/content/Context;
...
.method public setTextAppearance(Landroid/content/Context;I)V
    ...
    .line 2381
    .local v6, textcolor_res:I
    invoke-direct {p0, v6}, Landroid/widget/TextView;->invertTextColor(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    .line 2382
    .local v5, tempcolor:Landroid/content/res/ColorStateList;
    if-eqz v5, :cond_7

    .line 2383
    invoke-virtual {p0, v5}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    .line 2390
    .end local v5           #tempcolor:Landroid/content/res/ColorStateList;
    .end local v6           #textcolor_res:I
    :cond_2
    :goto_0
    const/4 v9, 0x0
    ...
    invoke-direct {p0, v3, v8, v4}, Landroid/widget/TextView;->setTypefaceFromAttrs(Ljava/lang/String;II)V
    ...
    .restart local v5       #tempcolor:Landroid/content/res/ColorStateList;
    .restart local v6       #textcolor_res:I
    :cond_7
