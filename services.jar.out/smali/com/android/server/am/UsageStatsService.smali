...
.method public notePauseComponent(Landroid/content/ComponentName;)V
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/android/server/am/UsageStatsService;->mIsResumed:Z
    ...
    :try_start_1
    iput-boolean v0, p0, Lcom/android/server/am/UsageStatsService;->mIsResumed:Z
    ...
    check-cast v8, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;

    .line 760
    .local v8, pus:Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;
    if-nez v8, :cond_3
    ...
    const-string v2, "No package stats for pkg:"
    ...
    .line 765
    :cond_3
    invoke-virtual {v8}, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->updatePause()V

    .line 768
    sget-boolean v0, Lcom/lenovo/smart/SmartAPI;->SUPPORT_SMART:Z

    if-eqz v0, :cond_4

    .line 770
    iget-object v0, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedPkg:Ljava/lang/String;
    ...
    .line 771
    iget-wide v0, p0, Lcom/android/server/am/UsageStatsService;->mLastDuration:J

    iget-wide v2, v8, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->mPausedTime:J

    iget-wide v4, v8, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->mResumedTime:J

    sub-long/2addr v2, v4

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/android/server/am/UsageStatsService;->mLastDuration:J
    ...
    .line 794
    invoke-direct {p0, v10, v10}, Lcom/android/server/am/UsageStatsService;->writeStatsToFile(ZZ)V
    ...
    .line 774
    :cond_6
    iput-object v7, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedPkg:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedClass:Ljava/lang/String;
    ...
    iput-wide v0, p0, Lcom/android/server/am/UsageStatsService;->mLastDate:J

    .line 777
    iget-wide v0, v8, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->mPausedTime:J

    iget-wide v2, v8, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->mResumedTime:J
    ...
    const-string v2, "addRunApplicationLog("

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedPkg:Ljava/lang/String;

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    const-string v2, ") mLastDuration = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Lcom/android/server/am/UsageStatsService;->mLastDuration:J
    ...
    iget-object v1, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedPkg:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/server/am/UsageStatsService;->mLastPausedClass:Ljava/lang/String;

    iget-wide v3, p0, Lcom/android/server/am/UsageStatsService;->mLastDate:J

    iget-wide v5, p0, Lcom/android/server/am/UsageStatsService;->mLastDuration:J

    invoke-static/range {v0 .. v6}, Lcom/lenovo/smart/SmartAPI;->addApplicationDurationLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JJ)V
