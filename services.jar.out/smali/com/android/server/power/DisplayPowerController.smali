...
.field private static final DARKENING_LIGHT_DEBOUNCE:J = 0x7530L
...
# instance fields
.field private isAdjLcdBrightnessFirstCall:Z
...
.field private mIsSmartBrightnessDebug:Z
...
.field private mScreenSmartBrightnessModeSetting:I

.field private final mSensorManager:Landroid/hardware/SensorManager;

.field private mSettingsObserver:Lcom/android/server/power/DisplayPowerController$SettingsObserver;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput-boolean v6, p0, Lcom/android/server/power/DisplayPowerController;->isAdjLcdBrightnessFirstCall:Z

    .line 1526
    const/4 v6, 0x0

    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->mLastLux:F

    .line 1527
    const/4 v6, 0x0

    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->mLastValue:F

    .line 1530
    const/4 v6, 0x1

    iput-boolean v6, p0, Lcom/android/server/power/DisplayPowerController;->mIsSmartBrightnessDebug:Z

    .line 1531
    const/4 v6, 0x0

    iput-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;
    ...
    const-string v6, "smart_brightness_mode"
    ...
    iput v6, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessModeSetting:I

    .line 438
    new-instance v6, Lcom/android/server/power/DisplayPowerController$SettingsObserver;

    iget-object v7, p0, Lcom/android/server/power/DisplayPowerController;->mHandler:Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;

    invoke-direct {v6, p0, v7}, Lcom/android/server/power/DisplayPowerController$SettingsObserver;-><init>(Lcom/android/server/power/DisplayPowerController;Landroid/os/Handler;)V

    iput-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mSettingsObserver:Lcom/android/server/power/DisplayPowerController$SettingsObserver;
    ...
    iget-object v8, p0, Lcom/android/server/power/DisplayPowerController;->mSettingsObserver:Lcom/android/server/power/DisplayPowerController$SettingsObserver;

    const/4 v9, -0x1

    invoke-virtual {v3, v6, v7, v8, v9}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    .line 448
    invoke-direct {p0}, Lcom/android/server/power/DisplayPowerController;->load()V

    .line 449
    iget v6, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessModeSetting:I

    invoke-direct {p0, v6}, Lcom/android/server/power/DisplayPowerController;->setSmartBrightnessMode(I)V

    .line 452
    iget-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mAutoBrightnessLevels:[I

    iget-object v7, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I

    invoke-static {v6, v7}, Lcom/android/server/power/DisplayPowerController;->createAutoBrightnessSpline([I[I)Landroid/util/Spline;
    ...
    iget-object v8, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I
    ...
    :cond_5
    iget-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I
...
.method static synthetic access$1400(Lcom/android/server/power/DisplayPowerController;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1500(Lcom/android/server/power/DisplayPowerController;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1600(Lcom/android/server/power/DisplayPowerController;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 96
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessModeSetting:I

    return v0
.end method

.method static synthetic access$1602(Lcom/android/server/power/DisplayPowerController;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 96
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessModeSetting:I

    return p1
.end method

.method static synthetic access$1700(Lcom/android/server/power/DisplayPowerController;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 96
    invoke-direct {p0, p1}, Lcom/android/server/power/DisplayPowerController;->setSmartBrightnessMode(I)V

    return-void
.end method

.method static synthetic access$1802(Lcom/android/server/power/DisplayPowerController;Landroid/util/Spline;)Landroid/util/Spline;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 96
    iput-object p1, p0, Lcom/android/server/power/DisplayPowerController;->mScreenAutoBrightnessSpline:Landroid/util/Spline;

    return-object p1
.end method

.method static synthetic access$1900(Lcom/android/server/power/DisplayPowerController;)[I
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2000(Lcom/android/server/power/DisplayPowerController;)[I
    .locals 1
    .parameter "x0"

    .prologue
    .line 96
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I
...
.method private getAutoBrightLevelPos(I)I
    .locals 2
    .parameter "v"
...
.method private getConfigArray(Ljava/lang/String;)[I
    .locals 10
    .parameter "key"
    ...
    .line 1648
    .local v1, arrayint:[I
    iget-object v7, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;
    ...
    const-string v9, "lincl1+++get config "
...
.method private getConfigParameter([II)Ljava/lang/String;
    .locals 5
    .parameter "array"
    .parameter "end"
    ...
    .line 1670
    .local v1, parameter:Ljava/lang/StringBuilder;
    const/4 v0, 0x0
    ...
    const-string v4, "lincl1+++the parameter is "
...
.method private load()V
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;
    ...
    const-string v6, "lincl1+++smart backlight  mJsonData is "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;
...
.method private setSmartBrightnessMode(I)V
    .locals 5
    .parameter "mode"
    ...
    .line 1565
    iget-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mJsonData:Ljava/lang/String;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->mIsSmartBrightnessDebug:Z
    ...
    const-string v3, "lincl1++<<<<< setSmartBrightnessMode >>>>> mode="
    ...
    .line 1567
    const-string v1, "lcd1"

    invoke-direct {p0, v1}, Lcom/android/server/power/DisplayPowerController;->getConfigArray(Ljava/lang/String;)[I

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mLcdBacklightValues:[I
    ...
    const-string v2, "lincl1+++smart backlight  mJsonData is null"
...
.method private shouldAdjLcdBrightness(II)Z
    .locals 5
    .parameter "oldval"
    .parameter "val"
    ...
    .line 1534
    iget-boolean v2, p0, Lcom/android/server/power/DisplayPowerController;->isAdjLcdBrightnessFirstCall:Z

    if-eqz v2, :cond_1

    .line 1535
    iput-boolean v1, p0, Lcom/android/server/power/DisplayPowerController;->isAdjLcdBrightnessFirstCall:Z
    ...
    const-string v4, "lincl1+++ old level is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-direct {p0, p1}, Lcom/android/server/power/DisplayPowerController;->getAutoBrightLevelPos(I)I
    ...
    const-string v4, "lincl1+++ new level is "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-direct {p0, p2}, Lcom/android/server/power/DisplayPowerController;->getAutoBrightLevelPos(I)I
    ...
    const-string v2, "lincl1+++ too close don\'t dimm lcdbrightness"
...
.method private updateAmbientLux(J)V
    ...
    const-string v6, "updateAmbientLux: Possibly darkened, waiting for 30000 ms: darkeningLuxThreshold="
...
.method private updateAutoBrightness(Z)V
    ...
    .line 1218
    :cond_1
    iget v2, p0, Lcom/android/server/power/DisplayPowerController;->mLastLux:F
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/power/DisplayPowerController;->shouldAdjLcdBrightness(II)Z
    ...
    const-string v3, "lincl1+++do animate"
    ...
    iput v2, p0, Lcom/android/server/power/DisplayPowerController;->mLastLux:F

    .line 1224
    iput v14, p0, Lcom/android/server/power/DisplayPowerController;->mLastValue:F
    ...
    const-string v4, "lincl1++++Current  auto brightness profile  is  "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/power/DisplayPowerController;->mScreenSmartBrightnessModeSetting:I
    ...
    const-string v4, "lincl++ updateAutoBrightness: mScreenAutoBrightness="
    ...
    .end local v12           #newScreenAutoBrightness:I
...
.method private writeFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "lincl1+++start to open file "
    ...
    const-string v5, "lincl1+++open file successed "
    ...
    const-string v5, "lincl1+++write file successed "
