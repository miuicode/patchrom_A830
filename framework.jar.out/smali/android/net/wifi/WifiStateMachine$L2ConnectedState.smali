...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$14100(Landroid/net/wifi/WifiStateMachine;)Z
    ...
    invoke-static {v4, v6}, Landroid/net/wifi/WifiStateMachine;->access$14202(Landroid/net/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiStateMachine;->access$14200(Landroid/net/wifi/WifiStateMachine;)I
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mDhcpV4Status:I
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$14200(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v6, v4}, Landroid/net/wifi/WifiStateMachine;->access$14400(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpInfoInternal;)V
    ...
    invoke-static {v6}, Landroid/net/wifi/WifiStateMachine;->access$14600(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v7}, Landroid/net/wifi/WifiStateMachine;->access$15300(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v4}, Landroid/net/wifi/WifiStateMachine;->access$14008(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v4, v1}, Landroid/net/wifi/WifiStateMachine;->access$15700(Landroid/net/wifi/WifiStateMachine;Landroid/net/wifi/RssiPacketCountInfo;)V
