...
.method public enter()V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$19300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiNative;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateMachine;->access$20700(Landroid/net/wifi/WifiStateMachine;)V
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiStateMachine;->access$20800(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v9

    #calls: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v8, v9}, Landroid/net/wifi/WifiStateMachine;->access$20900(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v8, v9}, Landroid/net/wifi/WifiStateMachine;->access$21002(Landroid/net/wifi/WifiStateMachine;Z)Z
    ...
    #getter for: Landroid/net/wifi/WifiStateMachine;->mHotspotNative:Landroid/net/wifi/WifiNative;
    invoke-static {v8}, Landroid/net/wifi/WifiStateMachine;->access$19300(Landroid/net/wifi/WifiStateMachine;)Landroid/net/wifi/WifiNative;
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateMachine;->access$21100(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/AsyncChannel;
    ...
    invoke-static {v8}, Landroid/net/wifi/WifiStateMachine;->access$21000(Landroid/net/wifi/WifiStateMachine;)Z
