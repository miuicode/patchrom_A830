...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v6, v7, v4, v1}, Landroid/net/UsbDataStateTracker;->access$500(Landroid/net/UsbDataStateTracker;Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Landroid/net/UsbDataStateTracker;->access$600(Landroid/net/UsbDataStateTracker;)Landroid/net/LinkProperties;
    ...
    invoke-static {v6}, Landroid/net/UsbDataStateTracker;->access$700(Landroid/net/UsbDataStateTracker;)Landroid/net/LinkCapabilities;
    ...
    invoke-static {v6}, Landroid/net/UsbDataStateTracker;->access$800(Landroid/net/UsbDataStateTracker;)Landroid/os/Handler;
    ...
    invoke-static {v6}, Landroid/net/UsbDataStateTracker;->access$1000(Landroid/net/UsbDataStateTracker;)Landroid/content/Context;
    ...
    invoke-static {v7}, Landroid/net/UsbDataStateTracker;->access$1100(Landroid/net/UsbDataStateTracker;)Landroid/os/Handler;
    ...
    invoke-static {v8}, Landroid/net/UsbDataStateTracker;->access$900(Landroid/net/UsbDataStateTracker;)Landroid/os/Messenger;
    ...
    invoke-static {v6, v7}, Landroid/net/UsbDataStateTracker;->access$1302(Landroid/net/UsbDataStateTracker;Z)Z
    ...
    invoke-static {v7, v6}, Landroid/net/UsbDataStateTracker;->access$1402(Landroid/net/UsbDataStateTracker;Z)Z
